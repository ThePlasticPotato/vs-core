...
internal interface VSPipelineDataConverter {
    ...
    fun convertToModel(data: VSPipelineDataV3): SerializedShipDataModule {
        return SerializedShipDataModule(QueryableShipDataImpl(convertShipData(data.ships)), data.chunkAllocator)
    }
