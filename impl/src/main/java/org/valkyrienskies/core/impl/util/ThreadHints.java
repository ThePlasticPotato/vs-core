...
/**
 * This class captures possible hints that may be used by some runtimes to improve code performance. It is intended to
 * capture hinting behaviours that are implemented in or anticipated to be spec'ed under the {@link java.lang.Thread}
...
public final class ThreadHints {
     ...
     * part of other activities.  By invoking this method within each iteration of a spin-wait loop construct, the
     * calling thread indicates to the runtime that it is busy-waiting. The runtime may take action to improve the
