...
class ServerShipDataV1Test : StringSpec({
    ...
    "can upgrade from v1 to v2" {
        ...
        val v1 = ServerShipDataV1(
            ...
            inertiaData = VSRandomUtils.randomShipInertiaDataV0(),
            shipTransform = VSRandomUtils.randomShipTransformDataV0(),
            prevTickShipTransform = VSRandomUtils.randomShipTransformDataV0(),
