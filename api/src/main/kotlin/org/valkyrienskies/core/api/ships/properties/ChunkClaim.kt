...
interface ChunkClaim {
    ...
    fun getCenterBlockCoordinates(yRange: LevelYRange, destination: Vector3i = Vector3i()): Vector3i

    fun getBlockSize(yRange: LevelYRange, destination: Vector3i = Vector3i()): Vector3i
